...
DETECTORS: dict[str, DetectorMeta] = {
    ...
    "orphaned": DetectorMeta(
        ...
        "Code quality",
        "reorganize",
        "delete dead files or relocate with `structorium move`",
        tool="move",
        needs_judgment=True,
    ),
    ...
    "flat_dirs": DetectorMeta(
        ...
        "Code quality",
        "reorganize",
        "create subdirectories and use `structorium move`",
        tool="move",
        needs_judgment=True,
    ),
    "naming": DetectorMeta(
        ...
        "Code quality",
        "reorganize",
        "rename files with `structorium move` to fix conventions",
        tool="move",
        needs_judgment=True,
    ),
    "single_use": DetectorMeta(
        ...
        "Code quality",
        "reorganize",
        "inline or relocate with `structorium move`",
        tool="move",
        needs_judgment=True,
    ),
    "coupling": DetectorMeta(
        ...
        "Code quality",
        "reorganize",
        "fix boundary violations with `structorium move`",
        tool="move",
        needs_judgment=True,
    ),
    "cycles": DetectorMeta(
        ...
        "Security",
        "reorganize",
        "break cycles by extracting shared code or using `structorium move`",
        tool="move",
        needs_judgment=True,
    ),
    "facade": DetectorMeta(
    ...
    "subjective_review": DetectorMeta(
        ...
        "Test health",
        "manual_fix",
        "run `structorium review --prepare` to evaluate files against quality dimensions",
    ),
}

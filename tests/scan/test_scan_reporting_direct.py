...
import app.commands.scan.scan_reporting_analysis as scan_reporting_analysis_mod
import app.commands.scan.scan_reporting_dimensions as scan_reporting_dimensions_mod
import app.commands.scan.scan_reporting_llm as scan_reporting_llm_mod
import app.commands.scan.scan_reporting_summary as scan_reporting_summary_mod
...
def test_show_post_scan_analysis_surfaces_warnings_and_headline(monkeypatch, capsys):
    import intelligence.narrative as narrative_mod

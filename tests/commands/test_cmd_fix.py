...
import app.commands.fix.apply_flow as fix_apply_mod
from app.commands.fix.apply_flow import (
    _SKIP_REASON_LABELS,
    _print_fix_retro,
    _print_fix_summary,
    _resolve_fixer_results,
)
from app.commands.fix.cmd import (
    cmd_fix,
)
from languages._framework.base.types import FixerConfig, FixResult
...
class TestFixModuleSanity:
    ...
    def test_fix_review_is_special_alias(self, monkeypatch):
        ...
        import app.commands.fix.cmd as fix_mod
...
class TestFixNarrativeReminders:
    def test_report_dry_run_uses_fix_command(self, monkeypatch, capsys):
        ...
        import app.commands.fix.apply_flow as fix_mod

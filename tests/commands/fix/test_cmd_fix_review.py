...
from app.commands.fix.cmd import cmd_fix
from app.commands.fix.review_flow import _cmd_fix_review
...
_P_LANG = "app.commands.fix.review_flow.resolve_lang"
_P_STATE_PATH = "app.commands.fix.review_flow.state_path"
_P_LOAD_STATE = "app.commands.fix.review_flow.state_mod.load_state"

_P_PREP = "intelligence.review.prepare_review"
_P_SETUP = "app.commands.fix.review_flow.review_runtime_mod.setup_lang_concrete"
_P_WQ = "app.commands.fix.review_flow.write_query"
...
class TestFixReviewInterception:
    ...
    def test_review_dispatched(self):
        ...
        args.fixer = "review"
        args.dry_run = False
        with patch("app.commands.fix.cmd._cmd_fix_review") as mock_review:
            cmd_fix(args)

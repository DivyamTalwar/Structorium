"""Tests for app.commands.zone_cmd — zone command helpers."""

import core.config as config_mod
from app.commands.helpers.runtime import CommandRuntime
from app.commands.zone_cmd import (
    _zone_clear,
    _zone_set,
    _zone_show,
    cmd_zone,
...
class TestCmdZoneDispatch:
    ...
    def test_missing_action_defaults_to_show(self, monkeypatch):
        calls = []
        monkeypatch.setattr(
            "app.commands.zone_cmd._zone_show",
    ...
    def test_set_action_dispatches(self, monkeypatch):
        calls = []
        monkeypatch.setattr(
            "app.commands.zone_cmd._zone_set",
    ...
    def test_clear_action_dispatches(self, monkeypatch):
        calls = []
        monkeypatch.setattr(
            "app.commands.zone_cmd._zone_clear",
...
class TestZoneSet:
    ...
    def test_valid_zone_value_saves(self, monkeypatch, capsys):
        ...
        monkeypatch.setattr(
            "app.commands.zone_cmd.rel", lambda p: p,
        )

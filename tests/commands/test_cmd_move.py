...
import app.commands.move.move as move_mod
from app.commands.move.move import _cmd_move_dir
from app.commands.move.move_language import (
    detect_lang_from_dir,
    detect_lang_from_ext,
    resolve_lang_for_file_move,
    resolve_move_verify_hint,
)
from app.commands.move.move_planning import dedup_replacements, resolve_dest
from core.discovery_api import resolve_path
from core.discovery_api import safe_write_text as safe_write
...
class TestResolveLangPrecedence:
    ...
    def test_explicit_lang_overrides_extension_detection(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "app.commands.move.move_language.resolve_lang",
    ...
    def test_directory_move_prefers_explicit_lang(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr(
            "app.commands.move.move_directory.detect_lang_from_dir",
            lambda _p: "typescript",
        )
        monkeypatch.setattr(
            "app.commands.move.move_directory.resolve_lang",
            lambda _args: type("L", (), {"name": "python"})(),
        )
        monkeypatch.setattr(
            "languages.get_lang",
        ...
        monkeypatch.setattr(
            "app.commands.move.move_directory.load_lang_move_module",

...
from app.commands.review.helpers import parse_dimensions
from app.commands.review.preflight import (
    _scored_dimensions,
...
_BUILD_WQ = "app.commands.review.preflight.build_work_queue"
...
_PREFLIGHT = "app.commands.review.entrypoint.review_rerun_preflight"
_RUNTIME = "app.commands.review.entrypoint.command_runtime"
_LANG = "app.commands.review.entrypoint.resolve_lang"
...
def test_prepare_calls_preflight():
    ...
    from app.commands.review.entrypoint import cmd_review
...
def test_merge_skips_preflight():
    ...
    with (
        ...
        patch(_RUNTIME, return_value=_mock_runtime()),
        patch(_LANG, return_value=MagicMock(name="python")),
        patch("app.commands.review.merge.do_merge"),
    ):

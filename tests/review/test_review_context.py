...
from intelligence.review.context import (
    ReviewContext,
    build_review_context,
    serialize_context,
)
from intelligence.review.context_holistic import build_holistic_context
from intelligence.review.context_signals.ai import gather_ai_debt_signals
from intelligence.review.context_signals.auth import gather_auth_context
from intelligence.review.context_signals.migration import (
    classify_error_strategy,
    gather_migration_signals,
)
from state import empty_state as make_empty_state
...
def mock_rel():
    ...
    with patch(
        "intelligence.review.context.rel",
...
class TestBuildReviewContext:
    ...
    def test_ai_debt_signals_populated(self, mock_lang, empty_state):
        ...
        with patch(
            "intelligence.review.context.read_file_text", return_value=comment_heavy
        ):
    ...
    def test_auth_patterns_populated(self, mock_lang, empty_state):
        ...
        with patch(
            "intelligence.review.context.read_file_text", return_value=route_content
        ):
            ctx = build_review_context(
                Path("/project"),
                mock_lang,
    ...
    def test_error_strategies_populated(self, mock_lang, empty_state):
        ...
        with patch(
            "intelligence.review.context.read_file_text", return_value=throw_content
        ):
            ctx = build_review_context(
                Path("/project"),
                mock_lang,
...
class TestBuildHolisticContext:
    ...
    def test_authorization_section_present_with_routes(self, mock_lang, empty_state):
        ...
        with patch(
            "intelligence.review.context_holistic.readers.read_file_text", return_value=content
        ):
    ...
    def test_ai_debt_section_present_with_signals(self, mock_lang, empty_state):
        ...
        with patch(
            "intelligence.review.context_holistic.readers.read_file_text",

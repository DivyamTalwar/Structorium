...
from state import MergeScanOptions, merge_scan
from state import empty_state as build_empty_state
from tests.review.shared_review_fixtures import _as_review_payload
...
class TestImportReviewFindings:
    ...
    def test_import_updates_review_cache(
        ...
        with patch("intelligence.review.importing.per_file.PROJECT_ROOT", tmp_path):

...
from core.registry import _DISPLAY_ORDER, DETECTORS
...
from scoring import DIMENSIONS, FILE_BASED_DETECTORS
from state import empty_state, find_suspect_detectors
...
class TestReviewCoverageFreshCache:
    ...
    def test_fresh_no_findings(self, tmp_path):
        ...
        with patch("engine.detectors.review_coverage.rel", return_value=rpath):
            entries, potential = detect_review_coverage(

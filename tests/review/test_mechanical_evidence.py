...
from intelligence.review.context_holistic.mechanical import (
...
class TestMechanicalStaleness:
    ...
    def test_new_findings_mark_assessments_stale(self):
        from engine._state.merge import merge_scan
        from engine._state.schema import empty_state
...
class TestStaleReminderGating:
    ...
    def test_stale_reminder_suppressed_when_queue_has_open_findings(self):
        from intelligence.narrative.reminders import _stale_assessment_reminder

...
class TestReviewImports:
    """Verify all public names are importable from intelligence.review."""
...
class TestSubmoduleImports:
    ...
    @pytest.mark.parametrize(
        "module",
        [
            "intelligence.review.dimensions.holistic",
            "intelligence.review.dimensions.lang",
            "intelligence.review.context",
            "intelligence.review.selection",
            "intelligence.review.prepare",
            "intelligence.review.importing.per_file",
            "intelligence.review.importing.holistic",
            "intelligence.review.importing.shared",
            "intelligence.review.remediation",
        ],
    )
    ...
    def test_no_circular_import(self):
        """Fresh import of intelligence.review succeeds without circular import errors."""
        # Remove cached modules to force fresh import
        to_remove = [k for k in sys.modules if k.startswith("intelligence.review")]
        removed = {}
        for k in to_remove:
            removed[k] = sys.modules.pop(k)
        try:
            # If we get here, no circular import
            imported = importlib.import_module("intelligence.review")

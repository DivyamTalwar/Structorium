...
from engine._state import filtering as state_query_mod
from state import (
    MergeScanOptions,
...
class TestWontfixAutoResolution:
    ...
    def test_empty_potentials_dict_not_treated_as_none(self):
        ...
        from state import find_suspect_detectors
...
class TestScoreAntiGaming:
    ...
    def test_manual_fixed_does_not_improve_verified_until_scan_confirms(self):
        from state import resolve_findings
    ...
    def test_ignore_pattern_suppresses_and_excludes_from_scoring(self):
        from state import remove_ignored_findings

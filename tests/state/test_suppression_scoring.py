...
from engine._scoring.detection import _iter_scoring_candidates
from engine._state.filtering import (
    open_scope_breakdown,
    remove_ignored_findings,
)
from engine._state.merge_findings import upsert_findings
from engine._state.scoring import _count_findings

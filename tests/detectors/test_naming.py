"""Tests for engine.detectors.naming — naming convention inconsistency detection."""

import os

import engine.detectors.naming as naming_mod
import utils as utils_mod
from engine.detectors.naming import (

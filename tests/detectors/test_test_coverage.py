"""Tests for engine.detectors.test_coverage — test coverage gap detection."""
...
import languages.typescript.test_coverage as ts_cov
from engine.detectors.coverage.mapping import (
...
from engine.detectors.test_coverage import detect_test_coverage
from engine.detectors.test_coverage.heuristics import _has_testable_logic
from engine.detectors.test_coverage.io import (
    clear_coverage_read_warning_cache_for_tests,
)
from engine.detectors.test_coverage.metrics import _file_loc
from engine.policy.zones import FileZoneMap, Zone, ZoneRule
from languages.python.test_coverage import _strip_py_comment
from languages.typescript.test_coverage import (
...
class TestInferLangName:
    ...
    def test_returns_none_when_no_languages_available(self, monkeypatch):
        monkeypatch.setattr("languages.available_langs", lambda: [])

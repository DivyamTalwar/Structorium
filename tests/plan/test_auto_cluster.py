...
from engine._plan.auto_cluster import (
    auto_cluster_findings,
    _cluster_name_from_key,
    _grouping_key,
)
from engine._plan.operations import (
    create_cluster,
    add_to_cluster,
    remove_from_cluster,
)
from engine._plan.schema import empty_plan, ensure_plan_defaults
from engine._work_queue.core import (
    QueueBuildOptions,
    build_work_queue,
    _collapse_clusters,
)
from engine._work_queue.ranking import item_sort_key
...
def test_generate_action_always_returns_something():
    ...
    from core.registry import DETECTORS
    from engine._plan.auto_cluster import _generate_action
...
def test_generate_action_strips_subtype_examples():
    ...
    from engine._plan.auto_cluster import _strip_guidance_examples
...
def test_narrative_actions_mention_clusters():
    ...
    from intelligence.narrative.action_engine import _annotate_with_clusters

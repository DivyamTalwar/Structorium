"""Tests for languages.csharp — CSharpConfig and discovery behavior."""

import pytest

import core._internal.text_utils as utils_text_mod
import file_discovery as file_discovery_mod

...
def test_make_ast_smells_phase_label():
    from languages._framework.treesitter.phases import make_ast_smells_phase
...
def test_make_ast_smells_phase_run_with_no_findings():
    ...
    with patch(
        "languages._framework.treesitter._smells.detect_empty_catches",
        return_value=[],
    ), patch(
        "languages._framework.treesitter._smells.detect_unreachable_code",
        return_value=[],
    ):
...
def test_make_cohesion_phase_run_with_entries():
    ...
    with patch(
        "languages._framework.treesitter._cohesion.detect_responsibility_cohesion",
...
def test_make_unused_imports_phase_run_with_entries():
    ...
    with patch(
        "languages._framework.treesitter._unused_imports.detect_unused_imports",
...
def test_all_treesitter_phases_returns_empty_when_unavailable():
    ...
    with patch(
        "languages._framework.treesitter.is_available",
        return_value=False,
    ):
        from languages._framework.treesitter.phases import (
...
def test_all_treesitter_phases_returns_empty_for_unknown_spec():
    ...
    with patch(
        ...
        "languages._framework.treesitter._specs.TREESITTER_SPECS",
        {},
    ):
        from languages._framework.treesitter.phases import (
            all_treesitter_phases,

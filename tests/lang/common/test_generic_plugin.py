...
from languages._framework.generic_parts.tool_runner import (
    run_tool,
    run_tool_result,
)
...
class TestLangsCommand:
    def test_all_builtin_langs_discoverable(self):
        ...
        from languages import available_langs
    ...
    def test_langs_hides_shared_phases_from_tool_list(self):
        from app.commands.langs import _get_tool_labels
...
class TestDynamicRegistration:
    def test_register_detector_adds_to_detectors_dict(self):
        from core.registry import DETECTORS, DetectorMeta, register_detector
    ...
    def test_register_detector_auto_refreshes_narrative(self):
        ...
        from core.registry import DETECTORS, DetectorMeta, register_detector
        from intelligence.narrative._constants import DETECTOR_TOOLS
...
class TestScoringIntegration:
    ...
    def test_generic_findings_score_with_correct_tier(self):
        from scoring import DETECTOR_SCORING_POLICIES
...
class TestFixers:
    def test_fix_cmd_creates_fixer_config(self):
        from languages._framework.base.types import FixerConfig
    ...
    def test_fixer_detect_calls_tool(self):
        ...
        with patch(
            "languages._framework.generic_parts.tool_runner.subprocess.run",
    ...
    def test_fixer_fix_handles_tool_unavailable(self):
        ...
        with patch(
            "languages._framework.generic_parts.tool_factories.subprocess.run",

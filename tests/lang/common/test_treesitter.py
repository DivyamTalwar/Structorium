...
class TestGoExtraction:
    def test_extract_functions(self, go_file, tmp_path):
        ...
        from languages._framework.treesitter._specs import GO_SPEC
...
class TestRustExtraction:
    def test_extract_functions(self, rust_file, tmp_path):
        ...
        from languages._framework.treesitter._specs import RUST_SPEC
...
class TestRubyExtraction:
    def test_extract_methods(self, ruby_file, tmp_path):
        ...
        from languages._framework.treesitter._specs import RUBY_SPEC
...
class TestJavaExtraction:
    def test_extract_methods(self, java_file, tmp_path):
        ...
        from languages._framework.treesitter._specs import JAVA_SPEC
...
class TestCExtraction:
    def test_extract_functions(self, c_file, tmp_path):
        ...
        from languages._framework.treesitter._specs import C_SPEC
...
class TestClassExtraction:
    ...
    def test_no_class_query_returns_empty(self, go_file, tmp_path):
        ...
        from languages._framework.treesitter._specs import BASH_SPEC
...
class TestNormalize:
    def test_strips_comments(self, tmp_path):
        ...
        from languages._framework.treesitter._normalize import normalize_body
        from languages._framework.treesitter._specs import GO_SPEC
...
class TestGracefulDegradation:
    ...
    def test_is_available_false_when_uninstalled(self):
        with patch.dict("sys.modules", {"tree_sitter_language_pack": None}):
            ...
            import languages._framework.treesitter as ts_mod
    ...
    def test_generic_lang_stubs_without_treesitter(self):
        ...
        import languages._framework.treesitter as ts_mod
        from languages._framework.generic import (
            empty_dep_graph,
        ...
        try:
            ...
            ts_mod._AVAILABLE = saved
            # Clean up registry.
            from languages._framework import registry_state
...
class TestGenericLangIntegration:
    def test_go_is_full_plugin(self):
        import languages.go  # noqa: F401
        from languages._framework.resolution import get_lang
...
class TestSpecValidation:
    ...
    def test_swift_spec(self):
        from languages._framework.treesitter._specs import SWIFT_SPEC
        self._test_spec(SWIFT_SPEC)

    def test_php_spec(self):
        from languages._framework.treesitter._specs import PHP_SPEC
    ...
    def test_cpp_spec(self):
        from languages._framework.treesitter._specs import CPP_SPEC
        self._test_spec(CPP_SPEC)

    def test_scala_spec(self):
        from languages._framework.treesitter._specs import SCALA_SPEC
        self._test_spec(SCALA_SPEC)

    def test_elixir_spec(self):
        from languages._framework.treesitter._specs import ELIXIR_SPEC
        self._test_spec(ELIXIR_SPEC)

    def test_haskell_spec(self):
        from languages._framework.treesitter._specs import HASKELL_SPEC
    ...
    def test_lua_spec(self):
        from languages._framework.treesitter._specs import LUA_SPEC
        self._test_spec(LUA_SPEC)

    def test_perl_spec(self):
        from languages._framework.treesitter._specs import PERL_SPEC
        self._test_spec(PERL_SPEC)

    def test_clojure_spec(self):
        from languages._framework.treesitter._specs import CLOJURE_SPEC
    ...
    def test_powershell_spec(self):
        from languages._framework.treesitter._specs import POWERSHELL_SPEC
        self._test_spec(POWERSHELL_SPEC)

    def test_gdscript_spec(self):
        from languages._framework.treesitter._specs import GDSCRIPT_SPEC
        self._test_spec(GDSCRIPT_SPEC)

    def test_dart_spec(self):
        from languages._framework.treesitter._specs import DART_SPEC
        self._test_spec(DART_SPEC)

    def test_js_spec(self):
        from languages._framework.treesitter._specs import JS_SPEC
        self._test_spec(JS_SPEC)

    def test_erlang_spec(self):
        from languages._framework.treesitter._specs import ERLANG_SPEC
        self._test_spec(ERLANG_SPEC)

    def test_ocaml_spec(self):
        from languages._framework.treesitter._specs import OCAML_SPEC
        self._test_spec(OCAML_SPEC)

    def test_fsharp_spec(self):
        from languages._framework.treesitter._specs import FSHARP_SPEC
...
class TestParseTreeCache:
    def test_cache_hit(self, go_file, tmp_path):
        from languages._framework.treesitter._cache import (
            _PARSE_CACHE,
            disable_parse_cache,
            enable_parse_cache,
        )
        from languages._framework.treesitter._extractors import _get_parser
...
class TestEslintParser:
    def test_parse_eslint_output(self):
        ...
        from languages._framework.generic import parse_eslint
    ...
    def test_parse_invalid_json(self):
        ...
        from languages._framework.generic import parse_eslint
        from languages._framework.generic_parts.parsers import ToolParserError
...
class TestNewLanguageIntegration:
    def test_javascript_registered(self):
        import languages.javascript  # noqa: F401
        from languages._framework.generic import (
            empty_dep_graph,
            noop_extract_functions,
        )
    ...
    def test_erlang_registered(self):
        import languages.erlang  # noqa: F401
        from languages._framework.resolution import get_lang
    ...
    def test_ocaml_registered(self):
        import languages.ocaml  # noqa: F401
        from languages._framework.resolution import get_lang
    ...
    def test_fsharp_registered(self):
        import languages.fsharp  # noqa: F401
        from languages._framework.resolution import get_lang
...
class TestEmptyCatches:
    def test_detect_empty_catch_python(self, tmp_path):
        from languages._framework.treesitter._smells import (
...
"""
        ...
        from languages._framework.treesitter import TreeSitterLangSpec
...
class TestResponsibilityCohesion:
    def test_cohesive_file_no_flags(self, tmp_path):
        from languages._framework.treesitter._cohesion import (
...
class TestUnusedImports:
    def test_unused_import_detected(self, tmp_path):
        from languages._framework.treesitter._specs import GO_SPEC
        from languages._framework.treesitter._unused_imports import (
...
class TestSignatureVariance:
    def test_detects_variance(self, tmp_path):
        from engine.detectors.signature import detect_signature_variance
        from languages._framework.treesitter._extractors import (
            ts_extract_functions,
        )
        from languages._framework.treesitter._specs import GO_SPEC
...
class TestPhaseWiring:
    ...
    def test_bash_has_no_unused_imports(self):
        ...
        import languages.bash  # noqa: F401
        from languages._framework.resolution import get_lang

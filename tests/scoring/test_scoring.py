"""Tests for scoring — objective dimension-based scoring system."""
...
class TestReviewScoringExclusion:
    ...
    def test_multiplier_constant_still_defined(self):
        ...
        from scoring import HOLISTIC_MULTIPLIER, HOLISTIC_POTENTIAL
...
class TestSubjectiveScoring:
    ...
    def test_scoring_allowed_subjective_uses_full_scorecard(self):
        ...
        import inspect
        import engine._state.scoring as state_scoring_mod
    ...
    def test_assessment_budget_blend(self):
        ...
        """
        from scoring import SUBJECTIVE_WEIGHT_FRACTION
        ...
        from intelligence.review import DIMENSIONS as REVIEW_DIMS

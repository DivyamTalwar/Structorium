"""Tests for structorium.engine.detectors.signature — detect_signature_variance."""

from structorium.engine.detectors.base import FunctionInfo
from structorium.engine.detectors.signature import _ALLOWLIST, detect_signature_variance

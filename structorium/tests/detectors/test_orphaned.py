"""Tests for structorium.engine.detectors.orphaned — orphaned file detection."""
...
class TestIsDynamicallyImported:
    ...
    @patch("structorium.engine.detectors.orphaned.rel")
...
class TestDetectOrphanedFiles:
    ...
    def test_files_with_importers_not_orphaned(self, tmp_path):
        ...
        with patch(
            "structorium.engine.detectors.orphaned.rel",

"""Tests for structorium.engine.detectors.test_coverage — test coverage gap detection."""
...
import structorium.languages.typescript.test_coverage as ts_cov
from structorium.engine.detectors.coverage.mapping import (
...
from structorium.engine.detectors.test_coverage import detect_test_coverage
from structorium.engine.detectors.test_coverage.heuristics import _has_testable_logic
from structorium.engine.detectors.test_coverage.io import (
    clear_coverage_read_warning_cache_for_tests,
)
from structorium.engine.detectors.test_coverage.metrics import _file_loc
from structorium.engine.policy.zones import FileZoneMap, Zone, ZoneRule
from structorium.languages.python.test_coverage import _strip_py_comment
from structorium.languages.typescript.test_coverage import (
...
class TestInferLangName:
    ...
    def test_returns_none_when_no_languages_available(self, monkeypatch):
        monkeypatch.setattr("structorium.languages.available_langs", lambda: [])

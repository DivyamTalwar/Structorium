...
_DETECTORS_DIR = _REPO_ROOT / "structorium" / "engine" / "detectors"
        ...
        for node in ast.walk(tree):
            if isinstance(node, ast.Import):
                for alias in node.names:
                    name = alias.name
                    if name == "structorium.languages" or name.startswith("structorium.languages."):
            ...
            if module == "structorium.languages" or module.startswith("structorium.languages."):

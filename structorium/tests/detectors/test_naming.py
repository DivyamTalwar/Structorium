"""Tests for structorium.engine.detectors.naming — naming convention inconsistency detection."""

import os

import structorium.engine.detectors.naming as naming_mod
import structorium.utils as utils_mod
from structorium.engine.detectors.naming import (

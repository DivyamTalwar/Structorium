...
from structorium.engine.planning.core import generate_findings
...
from structorium.languages.csharp.phases import _apply_csharp_actionability_gates
...
def test_csharp_scan_pipeline_runs_on_fixture():
    path = (Path("structorium") / "tests" / "fixtures" / "csharp" / "simple_app").resolve()
...
def test_csharp_signal_rich_fixture_emits_meaningful_findings(tmp_path):
    fixture = (Path("structorium") / "tests" / "fixtures" / "csharp" / "signal_rich").resolve()

...
from structorium.languages._framework.generic_parts.tool_runner import (
    run_tool,
    run_tool_result,
)
...
class TestGenericLang:
    def test_registers_and_resolves(self):
        from structorium.languages._framework import registry_state
        from structorium.languages._framework.base.types import LangConfig
...
class TestLangsCommand:
    def test_all_builtin_langs_discoverable(self):
        ...
        from structorium.languages import available_langs
    ...
    def test_langs_hides_shared_phases_from_tool_list(self):
        from structorium.app.commands.langs import _get_tool_labels
...
class TestDynamicRegistration:
    def test_register_detector_adds_to_detectors_dict(self):
        from structorium.core.registry import DETECTORS, DetectorMeta, register_detector
    ...
    def test_register_detector_appends_to_display_order(self):
        from structorium.core.registry import (
            _DISPLAY_ORDER,
            DETECTORS,
            DetectorMeta,
            register_detector,
    ...
    def test_register_detector_auto_refreshes_narrative(self):
        ...
        from structorium.core.registry import DETECTORS, DetectorMeta, register_detector
        from structorium.intelligence.narrative._constants import DETECTOR_TOOLS
...
class TestScoringIntegration:
    def test_generic_findings_contribute_to_code_quality_dimension(self):
        from structorium.scoring import DIMENSIONS
    ...
    def test_generic_findings_score_with_correct_tier(self):
        from structorium.scoring import DETECTOR_SCORING_POLICIES
...
class TestFixers:
    def test_fix_cmd_creates_fixer_config(self):
        from structorium.languages._framework.base.types import FixerConfig
    ...
    def test_fixer_detect_calls_tool(self):
        ...
        with patch(
            "structorium.languages._framework.generic_parts.tool_runner.subprocess.run",
    ...
    def test_fixer_fix_handles_tool_unavailable(self):
        ...
        with patch(
            "structorium.languages._framework.generic_parts.tool_factories.subprocess.run",

"""Tests for structorium.languages — register_lang, get_lang, available_langs, auto_detect_lang."""
...
from structorium.languages import (
    auto_detect_lang,
    available_langs,
    get_lang,
    register_lang,
...
from structorium.languages._framework.discovery import load_all
...
def test_auto_detect_python_project(tmp_path):
    ...
    with patch("structorium.utils.PROJECT_ROOT", tmp_path):

...
from structorium.languages._framework.base.shared_phases import phase_security
from structorium.languages._framework.base.types import LangSecurityResult

...
Tests cover:
  1. structorium.app.commands.resolve.render
  2. structorium.app.commands.status_parts.strict_target
  3. structorium.app.commands._show_terminal
  4. structorium.app.commands.viz_cmd
  5. structorium.app.commands.review.entrypoint
  6. structorium.app.commands.update_skill
"""
...
# ── 1. resolve/render.py ────────────────────────────────────────────────────
from structorium.app.commands.resolve.render import (
    _delta_suffix,
    _print_next_command,
...
class TestPrintResolveSummary:
    @patch("structorium.app.commands.resolve.render.colorize", side_effect=lambda t, _c: t)
...
class TestPrintScoreMovement:
    @patch("structorium.app.commands.resolve.render.state_mod")
    @patch("structorium.app.commands.resolve.render.colorize", side_effect=lambda t, _c: t)
    def test_scores_unavailable(self, _mock_colorize, mock_state, capsys):
        from structorium.state import ScoreSnapshot
...
class TestPrintNextCommand:
    ...
    def test_no_open_remaining(self, _mock_colorize, capsys):
        ...
        out = capsys.readouterr().out
        assert "structorium scan" in out
        assert result == "structorium scan"
    ...
    def test_review_remaining(self, _mock_colorize, capsys):
        ...
        assert result == "structorium next"
...
from structorium.app.commands.status_parts.strict_target import (  # noqa: E402
...
from structorium.app.commands._show_terminal import (  # noqa: E402
...
class TestShowFixDryRunSamples:
    @patch("structorium.app.commands._show_terminal.colorize", side_effect=lambda t, _c: t)
    @patch("structorium.app.commands._show_terminal._print_fix_file_sample")
...
class TestPrintFixFileSample:
    @patch("structorium.app.commands._show_terminal.colorize", side_effect=lambda t, _c: t)
    @patch("structorium.app.commands._show_terminal.rel", side_effect=lambda p: p)
...
from structorium.app.commands import viz_cmd  # noqa: E402
from structorium.app.commands.viz_cmd import cmd_tree, cmd_viz  # noqa: E402


class TestVizCmd:
    @patch("structorium.app.commands.viz_cmd._cmd_viz")
    def test_cmd_viz_delegates(self, mock_inner):
        args = argparse.Namespace()
        cmd_viz(args)
        mock_inner.assert_called_once_with(args)

    @patch("structorium.app.commands.viz_cmd._cmd_tree")
...
from structorium.app.commands.review.entrypoint import cmd_review  # noqa: E402


class TestCmdReviewEntrypoint:
    @patch("structorium.app.commands.review.entrypoint.do_prepare")
    @patch("structorium.app.commands.review.entrypoint.resolve_lang")
    @patch("structorium.app.commands.review.entrypoint.command_runtime")
    ...
    @patch("structorium.app.commands.review.entrypoint.do_import")
    @patch("structorium.app.commands.review.entrypoint.resolve_lang")
    @patch("structorium.app.commands.review.entrypoint.command_runtime")
    ...
    @patch("structorium.app.commands.review.entrypoint.do_validate_import")
    @patch("structorium.app.commands.review.entrypoint.resolve_lang")
    @patch("structorium.app.commands.review.entrypoint.command_runtime")
    ...
    @patch("structorium.app.commands.review.entrypoint._do_run_batches")
    @patch("structorium.app.commands.review.entrypoint.resolve_lang")
    @patch("structorium.app.commands.review.entrypoint.command_runtime")
    ...
    @patch("structorium.app.commands.review.entrypoint.do_external_start")
    @patch("structorium.app.commands.review.entrypoint.resolve_lang")
    @patch("structorium.app.commands.review.entrypoint.command_runtime")
    ...
    @patch("structorium.app.commands.review.entrypoint.do_external_submit")
    @patch("structorium.app.commands.review.entrypoint.resolve_lang")
    @patch("structorium.app.commands.review.entrypoint.command_runtime")
    ...
    @patch("structorium.app.commands.review.entrypoint.resolve_lang", return_value=None)
    @patch("structorium.app.commands.review.entrypoint.command_runtime")
    @patch("structorium.app.commands.review.entrypoint.colorize", side_effect=lambda t, _c: t)
...
from structorium.app.commands.update_skill import (  # noqa: E402
    _build_section,
    _replace_section,
    cmd_update_skill,
    resolve_interface,
...
class TestReplaceSection:
    ...
    def test_replaces_between_markers(self):
        from structorium.utils import SKILL_BEGIN, SKILL_END
        content = f"before\n{SKILL_BEGIN}\nold content\n{SKILL_END}\nafter"
...
class TestResolveInterface:
    ...
    def test_none_with_no_install(self):
        with patch(
            "structorium.app.commands.update_skill.find_installed_skill",
            return_value=None,
        ):
            assert resolve_interface(None) is None

    def test_from_install_overlay(self):
        from structorium.utils import SkillInstall
        install = SkillInstall(
            rel_path=".claude/skills/structorium/SKILL.md",
            version=1,
            overlay="claude",
            stale=False,
        )
    ...
    def test_from_install_path_match_opencode(self):
        ...
        install = SkillInstall(
            rel_path=".opencode/skills/structorium/SKILL.md",
            version=1,
            overlay=None,
            stale=False,
        )
...
class TestCmdUpdateSkill:
    @patch("structorium.app.commands.update_skill.update_installed_skill")
    @patch("structorium.app.commands.update_skill.resolve_interface", return_value="claude")
    ...
    @patch("structorium.app.commands.update_skill.colorize", side_effect=lambda t, _c: t)
    @patch("structorium.app.commands.update_skill.resolve_interface", return_value=None)
    ...
    @patch("structorium.app.commands.update_skill.colorize", side_effect=lambda t, _c: t)
    @patch("structorium.app.commands.update_skill.resolve_interface", return_value="unknown_thing")
...
class TestUpdateInstalledSkill:
    @patch("structorium.app.commands.update_skill.colorize", side_effect=lambda t, _c: t)
    @patch("structorium.app.commands.update_skill._download")
    ...
    def test_successful_dedicated_install(self, mock_download, _mock_colorize, capsys, tmp_path):
        ...
        with patch(
            "structorium.app.commands.update_skill.get_project_root",
            return_value=tmp_path,
        ):
            result = update_installed_skill("claude")

        assert result is True
        written = (tmp_path / ".claude" / "skills" / "structorium" / "SKILL.md").read_text()
        assert "structorium-skill-version" in written
        out = capsys.readouterr().out

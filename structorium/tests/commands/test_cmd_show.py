...
import structorium.app.commands.show.cmd as show_cmd_mod
import structorium.app.commands.show.scope as show_scope_mod
import structorium.state as state_mod
from structorium.app.commands.helpers.runtime import CommandRuntime
from structorium.app.commands.show.cmd import cmd_show
from structorium.app.commands.show.scope import resolve_entity
from structorium.app.commands.show.formatting import (
    DETAIL_DISPLAY,
    format_detail,
    suppressed_match_estimate,
)
from structorium.app.commands.show.payload import ShowPayloadMeta, build_show_payload
from structorium.app.commands.show.render import show_subjective_followup

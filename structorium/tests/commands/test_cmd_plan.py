"""Tests for structorium.app.commands.plan_cmd — plan generation command."""

import inspect

import structorium.engine.planning.core as plan_mod
from structorium.app.commands import plan_cmd
...
class TestCmdPlanOutput:
    ...
    def test_no_scan_prints_warning(self, monkeypatch, capsys):
        ...
        assert "Run: structorium scan" in out
        assert captured.err == ""

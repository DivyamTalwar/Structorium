...
from structorium.app.commands.review.helpers import parse_dimensions
from structorium.app.commands.review.preflight import (
    _scored_dimensions,
...
_BUILD_WQ = "structorium.app.commands.review.preflight.build_work_queue"
...
_PREFLIGHT = "structorium.app.commands.review.entrypoint.review_rerun_preflight"
_RUNTIME = "structorium.app.commands.review.entrypoint.command_runtime"
_LANG = "structorium.app.commands.review.entrypoint.resolve_lang"
...
def test_prepare_calls_preflight():
    ...
    from structorium.app.commands.review.entrypoint import cmd_review
...
def test_merge_skips_preflight():
    ...
    with (
        ...
        patch(_RUNTIME, return_value=_mock_runtime()),
        patch(_LANG, return_value=MagicMock(name="python")),
        patch("structorium.app.commands.review.merge.do_merge"),
    ):

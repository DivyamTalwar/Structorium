"""Regression tests for subjective issue visibility in `structorium status` output."""

from __future__ import annotations

from structorium.app.commands.status_parts import render as status_render

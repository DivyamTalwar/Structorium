"""Tests for structorium.app.commands.next."""
...
from structorium.app.commands import next as next_mod
from structorium.app.commands.helpers.runtime import CommandRuntime
from structorium.app.commands.next import _low_subjective_dimensions, cmd_next
...
class TestCmdNextOutput:
    def test_requires_prior_scan(self, monkeypatch, capsys):
        ...
        assert "No scans yet. Run: structorium scan" in out
    ...
    def test_tier_navigator_always_printed(self, monkeypatch, capsys):
        ...
        assert "structorium next --tier 1" in out
                ...
                "items": [
                    {
                        ...
                        "detail": {},
                        "status": "open",
                        "primary_command": "structorium plan done ...",
                    }
                ],
                "total": 1,
    ...
    def test_no_tier_fallback_strict_empty_guidance(self, monkeypatch, capsys):
        ...
        assert "Try: structorium next --tier 1 | structorium next --tier 2" in out

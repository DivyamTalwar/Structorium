"""Tests for `structorium fix review` command."""

from __future__ import annotations

from unittest.mock import MagicMock, patch

from structorium.app.commands.fix.cmd import cmd_fix
from structorium.app.commands.fix.review_flow import _cmd_fix_review
...
_P_LANG = "structorium.app.commands.fix.review_flow.resolve_lang"
_P_STATE_PATH = "structorium.app.commands.fix.review_flow.state_path"
_P_LOAD_STATE = "structorium.app.commands.fix.review_flow.state_mod.load_state"

_P_PREP = "structorium.intelligence.review.prepare_review"
_P_SETUP = "structorium.app.commands.fix.review_flow.review_runtime_mod.setup_lang_concrete"
_P_WQ = "structorium.app.commands.fix.review_flow.write_query"
...
class TestFixReviewDimensionPrompts:
    ...
    def test_prints_next_steps(self, capsys):
        ...
        with patches[0], patches[1], patches[2], patches[3], patches[4], patches[5]:
            _cmd_fix_review(args)
        out = capsys.readouterr().out
        assert "structorium review --import findings.json" in out
...
class TestFixReviewInterception:
    ...
    def test_review_dispatched(self):
        ...
        args.fixer = "review"
        args.dry_run = False
        with patch("structorium.app.commands.fix.cmd._cmd_fix_review") as mock_review:
            cmd_fix(args)

...
from structorium.app.commands.review.batches import _require_batches
from structorium.app.commands.review.import_helpers import (
...
from structorium.app.commands.review.prepare import do_prepare
from structorium.app.commands.review.runner_helpers import write_packet_snapshot
...
_P_SETUP = "structorium.app.commands.review.prepare.review_runtime_mod.setup_lang_concrete"
_P_NARRATIVE = "structorium.app.commands.review.prepare.narrative_mod.compute_narrative"
_P_REVIEW_PREP = "structorium.app.commands.review.prepare.review_mod.prepare_holistic_review"
_P_REVIEW_OPTS = "structorium.app.commands.review.prepare.review_mod.HolisticReviewPrepareOptions"
_P_NARRATIVE_CTX = "structorium.app.commands.review.prepare.narrative_mod.NarrativeContext"
_P_WRITE_QUERY = "structorium.app.commands.review.prepare.write_query"
...
def test_require_batches_guides_rebuild_when_packet_has_no_batches(capsys):
    with pytest.raises(SystemExit) as exc:
        _require_batches(
            {"investigation_batches": []},
            colorize_fn=_colorize,
            suggested_prepare_cmd="structorium review --prepare --path src",
        )
    assert exc.value.code == 1
    err = capsys.readouterr().err

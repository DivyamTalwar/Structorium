...
import structorium.app.commands.move.move as move_mod
from structorium.app.commands.move.move import _cmd_move_dir
from structorium.app.commands.move.move_language import (
    detect_lang_from_dir,
    detect_lang_from_ext,
    resolve_lang_for_file_move,
    resolve_move_verify_hint,
)
from structorium.app.commands.move.move_planning import dedup_replacements, resolve_dest
from structorium.core.discovery_api import resolve_path
from structorium.core.discovery_api import safe_write_text as safe_write
...
class TestResolveMoveVerifyHint:
    ...
    def test_prefers_get_verify_hint(self):
        move_mod_api = SimpleNamespace(
            get_verify_hint=lambda: "structorium detect deps",
            VERIFY_HINT="legacy hint",
        )
        assert resolve_move_verify_hint(move_mod_api) == "structorium detect deps"
...
class TestResolveLangPrecedence:
    ...
    def test_explicit_lang_overrides_extension_detection(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "structorium.app.commands.move.move_language.resolve_lang",
    ...
    def test_directory_move_prefers_explicit_lang(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr(
            "structorium.app.commands.move.move_directory.detect_lang_from_dir",
            lambda _p: "typescript",
        )
        monkeypatch.setattr(
            "structorium.app.commands.move.move_directory.resolve_lang",
            lambda _args: type("L", (), {"name": "python"})(),
        )
        monkeypatch.setattr(
        ...
        monkeypatch.setattr(
            "structorium.app.commands.move.move_directory.load_lang_move_module",

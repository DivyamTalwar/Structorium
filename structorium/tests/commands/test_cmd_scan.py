"""Tests for structorium.app.commands.scan — scan helper functions."""

from types import SimpleNamespace

import pytest

import structorium.app.commands.scan.scan as scan_cmd_mod
import structorium.app.commands.scan.scan_artifacts as scan_artifacts_mod
import structorium.intelligence.narrative as narrative_mod
import structorium.languages as lang_mod
from structorium.app.commands.scan.scan import (
    ...
    def test_shows_headline_and_pointers(self, monkeypatch, capsys):
        monkeypatch.setattr(
            ...
            lambda state, **kw: {
                ...
                "actions": [
                    {
                        "command": "structorium fix unused-imports",
    ...
    def test_reminders_and_plan_fields_removed_from_scan(self, monkeypatch, capsys):
        ...
        monkeypatch.setattr(
            ...
            lambda state, **kw: {
                ...
                "primary_action": {"command": "structorium show security", "description": "review security"},

...
from structorium.cli import create_parser
from structorium.core.registry import DETECTORS, display_order
...
from structorium.intelligence.review.context import serialize_context
...
class TestNarrativeIntegration:
    ...
    def test_review_not_run_reminder_when_score_high(self):
        ...
        assert "structorium review --prepare" in review_reminder["message"]
    ...
    def test_review_run_batches_flags(self):
        ...
        args = parser.parse_args(
            [
                ...
                "--save-run-log",
                "--run-log-file",
                ".structorium/subagents/runs/custom.log",
                "--dry-run",
                "--only-batches",
                "1,3",
            ]
        ...
        assert args.run_log_file == ".structorium/subagents/runs/custom.log"

...
from structorium.core.issues_render import finding_weight, render_issue_detail
...
def test_remediation_empty_plan_renders_scores_block():
    ...
    assert (
        "structorium --lang python review --prepare --path <src>" in content
    )
...
def test_issues_render_builds_markdown_payload():
    ...
    assert "structorium plan done" in rendered

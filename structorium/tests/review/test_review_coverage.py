...
from structorium.core.registry import _DISPLAY_ORDER, DETECTORS
...
from structorium.languages._framework.runtime import make_lang_run
from structorium.languages.python import PythonConfig
from structorium.languages.typescript import TypeScriptConfig
from structorium.scoring import DIMENSIONS, FILE_BASED_DETECTORS
from structorium.state import empty_state, find_suspect_detectors
...
class TestReviewCoverageFreshCache:
    ...
    def test_fresh_no_findings(self, tmp_path):
        ...
        with patch("structorium.engine.detectors.review_coverage.rel", return_value=rpath):
            entries, potential = detect_review_coverage(

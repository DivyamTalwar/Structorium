"""Tests for structorium.intelligence.narrative — pure narrative computation functions."""

from __future__ import annotations

from structorium.intelligence.narrative._constants import _FEEDBACK_URL, STRUCTURAL_MERGE
from structorium.intelligence.narrative.core import (
    NarrativeContext,
    _count_open_by_detector,
    compute_narrative,
)
from structorium.intelligence.narrative.dimensions import _analyze_debt
from structorium.intelligence.narrative.headline import _compute_headline
from structorium.intelligence.narrative.phase import _detect_milestone, _detect_phase
from structorium.intelligence.narrative.reminders import _compute_reminders
from structorium.intelligence.narrative.strategy_engine import (
...
class TestComputeReminders:
        ...
        actions = [
            {
                "type": "auto_fix",
                "count": 5,
                "command": "structorium fix unused-imports --dry-run",
            }
        ]
        reminders, _ = _compute_reminders(
            state,
    ...
    def test_reminders_include_metadata_and_rank_high_priority_first(self):
        state = {"strict_score": 50.0}
        actions = [{"type": "auto_fix", "count": 3, "command": "structorium fix unused-imports --dry-run"}]
        reminders, _ = _compute_reminders(
...
class TestComputeHeadline:
    ...
    def test_middle_grind_with_lowest_dim(self):
        ...
        assert "`structorium next`" in result
...
class TestReviewHeadline:
    ...
    def test_review_suffix_with_uninvestigated(self):
        ...
        assert headline is not None
        assert "structorium show review" in headline
    ...
    def test_review_suffix_all_investigated(self):
        ...
        assert "structorium show review" not in headline
...
class TestReviewReminders:
    ...
    def test_review_findings_pending_reminder(self):
        ...
        assert "structorium show review" in msg["message"]
...
class TestStrategyReviewHint:
    ...
    def test_review_appended_to_hint(self):
        ...
        actions = [
            {
                ...
                "count": 1,
                "impact": 1.0,
                "command": "structorium fix unused",
            },
            {
                "priority": 2,
                "type": "refactor",
        ...
        assert "structorium show review" in result["hint"]
    ...
    def test_no_review_in_hint_without_action(self):
        ...
        assert "structorium show review" not in result["hint"]
...
class TestComputeNarrativeContract:
    def test_includes_primary_action_verification_and_risks(self):
        ...
        assert narrative["verification_step"]["command"] == "structorium scan"

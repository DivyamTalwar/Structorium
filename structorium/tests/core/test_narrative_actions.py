...
from structorium.intelligence.narrative.action_engine import (
    _fixer_has_applicable_findings,
)
from structorium.intelligence.narrative.action_engine import (
    compute_actions as _compute_actions,
)
from structorium.intelligence.narrative.action_models import ActionContext
from structorium.intelligence.narrative.action_tools import (
    compute_tools as _compute_tools,
)
from structorium.state import empty_state as empty_state_factory
...
class TestComputeActions:
    ...
    def test_subjective_review_action(self, empty_state):
        ...
        if sr_actions:
            assert sr_actions[0]["command"] == "structorium review --prepare"

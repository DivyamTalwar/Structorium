"""Tests for structorium.utils — paths, exclusions, file discovery, grep, hashing."""
...
import structorium.core._internal.text_utils as utils_text_mod
import structorium.file_discovery as file_discovery_mod
import structorium.utils as utils_mod

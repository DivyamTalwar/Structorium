"""Tests for structorium.search and structorium.versioning modules."""
...
import structorium.search as search_mod
from structorium.search import (
    grep_count_files,
    grep_files,
    grep_files_containing,
)
from structorium.versioning import check_tool_staleness, compute_tool_hash
...
def test_compute_tool_hash_excludes_test_files(tmp_path):
    ...
    import structorium.versioning as versioning_mod
...
def test_check_tool_staleness_returns_warning_when_hash_differs():
    ...
    assert "structorium scan" in result

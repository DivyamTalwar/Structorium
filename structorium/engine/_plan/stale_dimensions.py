...
from structorium.engine._plan.schema import PlanModel, ensure_plan_defaults
from structorium.engine._state.schema import StateModel
...
def _current_stale_ids(state: StateModel) -> set[str]:
    ...
    from structorium.engine._work_queue.helpers import slugify

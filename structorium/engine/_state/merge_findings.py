...
from structorium.engine._state.filtering import matched_ignore_pattern
from structorium.core.discovery_api import matches_exclusion
...
def find_suspect_detectors(
    ...
    # 'review' findings enter via `structorium review --import`, not via scan phases.

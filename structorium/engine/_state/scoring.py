...
from structorium.engine._scoring.policy.core import matches_target_score
from structorium.engine._state.filtering import path_scoped_findings
from structorium.engine._state.schema import StateModel, ensure_state_defaults
from structorium.languages._framework.base.types import ScanCoverageRecord
...
def _update_objective_health(
    ...
    *,
    ...
    # Deferred import to avoid circular dependency with structorium.scoring
    ...
    if lang_name:
        try:
            from structorium.intelligence.review.dimensions.data import (

...
from structorium.engine.detectors.patterns.security import LOG_CALLS as _LOG_CALLS
from structorium.engine.detectors.patterns.security import RANDOM_CALLS as _RANDOM_CALLS
from structorium.engine.detectors.patterns.security import (
    SECRET_FORMAT_PATTERNS as _SECRET_FORMAT_PATTERNS,
)
from structorium.engine.detectors.patterns.security import (
    SECRET_NAME_RE as _SECRET_NAME_RE,
)
from structorium.engine.detectors.patterns.security import SECRET_NAMES as _SECRET_NAMES
from structorium.engine.detectors.patterns.security import (

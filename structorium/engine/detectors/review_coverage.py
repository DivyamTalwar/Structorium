...
from structorium.core.discovery_api import read_file_text, rel, resolve_path
from structorium.hook_registry import get_lang_hook
            ...
            entries.append(
                {
                    ...
                    "tier": 4,
                    "confidence": "low",
                    "summary": "No design review on record — run `structorium review --prepare`",
        ...
        return [
            {
                ...
                "tier": 4,
                "confidence": "low",
                "summary": "No holistic codebase review on record — run `structorium review --prepare`",

...
from structorium.engine.planning.common import is_subjective_phase
from structorium.engine.policy.zones import ZONE_POLICIES, FileZoneMap
from structorium.core.file_paths import rel
from structorium.languages import auto_detect_lang, available_langs, get_lang
from structorium.languages._framework.base.types import DetectorPhase, LangConfig
from structorium.languages._framework.runtime import LangRun, make_lang_run
...
def _build_zone_map(path: Path, lang: LangRun, zone_overrides: dict[str, str] | None) -> None:
    ...
    from structorium.languages._framework.generic import capability_report

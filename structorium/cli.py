...
from structorium.app.cli_support.parser import create_parser as _create_parser
from structorium.app.commands.helpers.lang import LangResolutionError, resolve_lang
from structorium.app.commands.helpers.runtime import CommandRuntime
from structorium.app.commands.helpers.state import state_path
from structorium.core._internal.text_utils import get_project_root
from structorium.core.config import load_config
from structorium.core.discovery_api import set_exclusions
from structorium.core.output_api import colorize
from structorium.core.paths_api import get_default_path
from structorium.core.runtime_state import runtime_scope
from structorium.languages import available_langs
from structorium.state import load_state
...
def _get_detector_names() -> list[str]:
    ...
    if _DETECTOR_NAMES is None:
        from structorium.core.registry import detector_names
...
def _resolve_default_path(args) -> None:
    ...
    default so that ``structorium review --prepare`` works on the same scope as
...
def _resolve_handler(command: str):
    from structorium.app.commands.registry import get_command_handlers

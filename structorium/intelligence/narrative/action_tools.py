...
from structorium.intelligence.narrative.action_engine import supported_fixers
from structorium.intelligence.narrative.action_models import ToolFixer, ToolInventory
...
def compute_tools(
    ...
    return {
        ...
        "move": {
            ...
            "usage": "structorium move <source> <dest> [--dry-run]",
        },
        "plan": {
            "command": "structorium plan",

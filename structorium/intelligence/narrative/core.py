...
from structorium.core.config import load_config as _load_config
from structorium.intelligence.narrative._constants import STRUCTURAL_MERGE
from structorium.intelligence.narrative.action_engine import compute_actions
from structorium.intelligence.narrative.action_models import (
    ActionContext,
)
from structorium.intelligence.narrative.action_tools import compute_tools
from structorium.intelligence.narrative.dimensions import (
    _analyze_debt,
    _analyze_dimensions,
)
...
from structorium.intelligence.narrative.strategy_engine import compute_strategy
from structorium.intelligence.narrative.types import (
    BadgeStatus,
    NarrativeResult,
    PrimaryAction,
    RiskFlag,

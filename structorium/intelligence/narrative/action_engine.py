...
from structorium.intelligence.narrative.action_models import ActionContext, ActionItem
...
from structorium.state import StateModel
            ...
            actions.append(
                {
                    ...
                    "description": (
                        ...
                        f"`structorium next` and fix manually"
                    ),
                    "command": f"structorium show {detector} --status open",
                    "impact": impact,
        ...
        actions.append(
            {
                ...
                "description": (
                    ...
                    f"`structorium fix {fixer} --dry-run` to preview, then apply"
                ),
                "command": f"structorium fix {fixer} --dry-run",
                "impact": impact,
                "dimension": _dimension_name(detector),
            }
        )
...
def _build_refactor_entry(
    ...
    if detector == "subjective_review":
        ...
        description = (
            ...
            "run `structorium show review --status open` to see them"
        )

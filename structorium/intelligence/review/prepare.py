...
from structorium.core.discovery_api import (
    disable_file_cache,
    enable_file_cache,
...
from structorium.intelligence.review._context.models import HolisticContext
from structorium.intelligence.review._prepare.helpers import (
    HOLISTIC_WORKFLOW,
    append_full_sweep_batch,
)
from structorium.intelligence.review._prepare.issue_history import (
...
from structorium.intelligence.review.dimensions.lang import get_lang_guidance
...
def prepare_holistic_review(
    ...
    try:
        from structorium.engine.concerns import generate_concerns

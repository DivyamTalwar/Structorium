...
from structorium.languages.python.detectors.smells_ast._dispatch import (
    _detect_ast_smells as detect_ast_smells,
)
from structorium.languages.python.detectors.smells_ast._source_detectors import (

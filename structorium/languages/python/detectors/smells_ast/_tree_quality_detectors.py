...
from structorium.languages.python.detectors.smells_ast._shared import (
    _is_docstring,
    _is_log_or_print,
    _is_return_none,
    _is_trivial_if,
...
from structorium.languages.python.detectors.smells_ast._tree_quality_detectors_types import (

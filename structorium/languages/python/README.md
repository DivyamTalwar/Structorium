...
`structorium.languages.python.detectors.smells_ast` is split by role:
...
4. Wire smell metadata in `/Users/peteromalley/Documents/structorium/structorium/languages/python/detectors/smells.py`.

"""Tests for structorium.languages.python.detectors.unused — ruff/pyflakes unused detection."""
...
from structorium.languages.python.detectors.unused import detect_unused

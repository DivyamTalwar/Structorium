"""Tests for structorium.languages.python.detectors.complexity — Python complexity signals."""

import textwrap

from structorium.languages.python.detectors import complexity as complexity_mod

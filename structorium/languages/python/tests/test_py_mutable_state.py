"""Tests for structorium.languages.python.detectors.mutable_state — global mutable config detection."""

import textwrap
from pathlib import Path

from structorium.languages.python.detectors.mutable_state import (

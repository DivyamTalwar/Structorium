"""Tests for structorium.languages.python.detectors.smells — Python code smell detection."""

import textwrap
from pathlib import Path

from structorium.languages.python.detectors import smells as smells_mod
from structorium.languages.python.detectors.smells import (
    detect_smells,
)

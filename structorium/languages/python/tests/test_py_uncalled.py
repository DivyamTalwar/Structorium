...
from structorium.languages.python.detectors.uncalled import detect_uncalled_functions
...
def test_self_scan_no_false_positives():
    """Run detector on the structorium codebase — known-used functions must not appear."""
    scan_root = Path(__file__).resolve().parents[3]  # structorium/

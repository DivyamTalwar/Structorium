"""Tests for structorium.languages.python.detectors.dict_keys — dict key flow analysis."""

import textwrap
from pathlib import Path

from structorium.languages.python.detectors import dict_keys as dict_keys_mod
from structorium.languages.python.detectors.dict_keys import (

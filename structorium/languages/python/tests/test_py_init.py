"""Tests for structorium.languages.python — PythonConfig and configuration data."""

import shutil

from structorium.engine.policy.zones import Zone
from structorium.languages.python import (

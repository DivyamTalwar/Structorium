...
from structorium.engine.detectors import dupes as dupes_detector_mod
...
from structorium.core.discovery_api import find_py_files, rel
...
from structorium.languages.python.detectors import smells as smells_detector_mod
from structorium.languages.python.detectors import unused as unused_detector_mod
from structorium.languages.python.extractors import (
...
from structorium.core.output_api import colorize, display_entries, print_table

if TYPE_CHECKING:
    import argparse

from structorium.languages._framework.commands_base import (
    make_cmd_complexity,
    make_cmd_facade,
    make_cmd_large,
    make_cmd_naming,

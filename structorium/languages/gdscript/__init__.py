...
from structorium.languages.gdscript import test_coverage as gdscript_test_coverage_hooks
from structorium.languages.gdscript.commands import get_detect_commands
from structorium.languages.gdscript.detectors.deps import (
    build_dep_graph as build_gdscript_dep_graph,
)
from structorium.languages.gdscript.extractors import (
    GDSCRIPT_FILE_EXCLUSIONS,
    extract_functions,
    find_gdscript_files,
)
from structorium.languages.gdscript.phases import _phase_coupling, _phase_structural
from structorium.languages.gdscript.review import (

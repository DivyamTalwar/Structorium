"""Tests for ``structorium.languages.gdscript`` configuration wiring."""

from __future__ import annotations

from structorium.languages.gdscript import GdscriptConfig
...
def test_file_finder_skips_godot_artifacts(tmp_path):
    ...
    from structorium.core.source_discovery import clear_source_file_cache_for_tests

"""TypeScript/React language configuration for structorium."""

from __future__ import annotations

from pathlib import Path

from structorium.core._internal.text_utils import get_area
from structorium.core.source_discovery import find_ts_files
from structorium.engine.detectors.base import FunctionInfo
from structorium.engine.policy.zones import COMMON_ZONE_RULES, Zone, ZoneRule
from structorium.hook_registry import register_lang_hooks
from structorium.languages import register_lang
from structorium.languages._framework.base.phase_builders import (
    detector_phase_security,
    detector_phase_signature,
    detector_phase_test_coverage,
    shared_subjective_duplicates_tail,
)
from structorium.languages._framework.base.types import (
    BoundaryRule,
    DetectorPhase,
    FixerConfig,
    FixResult,
...
from structorium.languages._framework.treesitter.phases import make_cohesion_phase
from structorium.languages.typescript import commands as ts_commands_mod
from structorium.languages.typescript import fixers as ts_fixers_mod
from structorium.languages.typescript import test_coverage as ts_test_coverage_hooks
...
from structorium.languages.typescript.detectors.security import detect_ts_security
from structorium.languages.typescript.extractors import extract_ts_functions
from structorium.languages.typescript.phases import (
    TS_COMPLEXITY_SIGNALS as TS_COMPLEXITY_SIGNALS,
)
from structorium.languages.typescript.phases import TS_GOD_RULES as TS_GOD_RULES
from structorium.languages.typescript.phases import TS_SKIP_DIRS as TS_SKIP_DIRS
from structorium.languages.typescript.phases import TS_SKIP_NAMES as TS_SKIP_NAMES
from structorium.languages.typescript.phases import (
    phase_coupling,
    phase_deprecated,
    phase_exports,
...
from structorium.languages.typescript.review import (
...
from structorium.languages.typescript.review import REVIEW_GUIDANCE as TS_REVIEW_GUIDANCE
from structorium.languages.typescript.review import api_surface as ts_review_api_surface
from structorium.languages.typescript.review import (
...
def _ts_treesitter_phases() -> list[DetectorPhase]:
    ...
    """
    from structorium.languages._framework.treesitter import get_spec, is_available

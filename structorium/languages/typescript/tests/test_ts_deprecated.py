"""Tests for structorium.languages.typescript.detectors.deprecated — @deprecated symbol detection."""

from pathlib import Path

import pytest

import structorium.languages.typescript.detectors.deprecated as deprecated_detector_mod

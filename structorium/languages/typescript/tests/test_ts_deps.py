"""Tests for structorium.languages.typescript.detectors.deps — dependency graph and import analysis."""
...
import structorium.languages.typescript.detectors.deps as deps_detector_mod

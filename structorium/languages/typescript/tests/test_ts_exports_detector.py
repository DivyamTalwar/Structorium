"""Tests for structorium.languages.typescript.detectors.exports — dead exports detection."""
...
import structorium.languages.typescript.detectors.exports as exports_mod

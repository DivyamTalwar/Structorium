"""Tests for structorium.languages.typescript.detectors.unused — unused declaration detection.
...
import structorium.languages.typescript.detectors.unused as ts_unused_mod
from structorium.languages.typescript.detectors.unused import (
    TS6133_RE,
    TS6192_RE,
    _categorize_unused,
    detect_unused,

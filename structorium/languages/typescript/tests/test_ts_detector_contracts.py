...
from structorium.languages.typescript.detectors.contracts import (
    DetectorResult,
)
from structorium.languages.typescript.detectors.deprecated import (
    cmd_deprecated,
    detect_deprecated,
    detect_deprecated_result,
)
from structorium.languages.typescript.detectors.logs import (
    detect_logs,
    detect_logs_result,
)
from structorium.languages.typescript.detectors.patterns import (
    detect_pattern_anomalies,
    detect_pattern_anomalies_result,
)
from structorium.languages.typescript.detectors.security import (
    detect_ts_security,

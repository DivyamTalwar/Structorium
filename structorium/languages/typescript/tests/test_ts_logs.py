"""Tests for structorium.languages.typescript.detectors.logs — tagged console.log detection."""

from pathlib import Path

import pytest

from structorium.languages.typescript.detectors.logs import TAG_EXTRACT_RE, detect_logs

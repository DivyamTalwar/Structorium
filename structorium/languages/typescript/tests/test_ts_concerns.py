"""Tests for structorium.languages.typescript.detectors.concerns — mixed concern detection."""

from pathlib import Path

import pytest

import structorium.languages.typescript.detectors.concerns as concerns_detector_mod

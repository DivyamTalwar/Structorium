...
from structorium.core.file_paths import rel, resolve_path
from structorium.core.grep import grep_files
from structorium.core.output import colorize, print_table
from structorium.engine.detectors.graph import (
    detect_cycles,
    finalize_graph,
    get_coupling_score,
)
...
from structorium.languages.typescript.detectors.deps_runtime import (

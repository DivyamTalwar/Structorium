...
from structorium.languages.typescript.detectors._smell_helpers import scan_code
from structorium.languages.typescript.fixers.fixer_io import apply_fixer
from structorium.languages.typescript.fixers.syntax_scan import collapse_blank_lines

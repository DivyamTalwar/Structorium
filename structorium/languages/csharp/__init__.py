"""C#/.NET language configuration for Structorium."""
...
from structorium.languages._framework.treesitter.phases import all_treesitter_phases
from structorium.languages.csharp import move as csharp_move_helpers
from structorium.languages.csharp import test_coverage as csharp_test_coverage_hooks
from structorium.languages.csharp.commands import get_detect_commands
from structorium.languages.csharp.detectors.deps import (
    build_dep_graph as build_csharp_dep_graph,
)
from structorium.languages.csharp.detectors.security import detect_csharp_security
from structorium.languages.csharp.extractors import (
    CSHARP_FILE_EXCLUSIONS,
    extract_csharp_functions,
    find_csharp_files,
)
from structorium.languages.csharp.phases import _phase_coupling, _phase_structural
from structorium.languages.csharp.review import (
...
from structorium.languages.csharp.review import REVIEW_GUIDANCE as CSHARP_REVIEW_GUIDANCE
from structorium.languages.csharp.review import api_surface as csharp_review_api_surface
from structorium.languages.csharp.review import (

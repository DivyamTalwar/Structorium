...
from structorium.languages.csharp.detectors.deps import cmd_cycles as cmd_cycles_deps
from structorium.languages.csharp.detectors.deps import cmd_deps as cmd_deps_direct
from structorium.languages.csharp.extractors import (
    extract_csharp_functions,
    find_csharp_files,
)
from structorium.languages.csharp.phases import CSHARP_COMPLEXITY_SIGNALS

...
from structorium.languages._framework.generic_parts.parsers import PARSERS
...
from structorium.languages._framework.generic_parts.tool_spec import ToolSpec

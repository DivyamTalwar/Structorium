...
def __getattr__(name: str):  # noqa: N807
    ...
    if name in _PHASE_EXPORTS:
        from structorium.languages._framework.treesitter import phases as phases_mod

        return getattr(phases_mod, name)
    if name == "TREESITTER_SPECS" or name.endswith("_SPEC"):
        from structorium.languages._framework.treesitter import _specs as specs_mod

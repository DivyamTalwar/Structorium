...
from structorium.core._internal.coercions import coerce_confidence
from structorium.core._internal.text_utils import get_project_root
from structorium.engine.detectors.base import ComplexitySignal
from structorium.engine.detectors.complexity import detect_complexity
from structorium.engine.detectors.dupes import detect_duplicates
from structorium.engine.detectors.flat_dirs import (
    detect_flat_dirs,
    format_flat_dir_summary,
)
from structorium.engine.detectors.graph import detect_cycles
from structorium.engine.detectors.jscpd_adapter import detect_with_jscpd
from structorium.engine.detectors.large import detect_large_files
from structorium.engine.detectors.orphaned import (
    OrphanedDetectionOptions,
    detect_orphaned_files,
)
from structorium.engine.detectors.review_coverage import (
    detect_holistic_review_staleness,
    detect_review_coverage,
)
from structorium.engine.detectors.security.detector import detect_security_issues
from structorium.engine.detectors.single_use import detect_single_use_abstractions
from structorium.engine.detectors.test_coverage.detector import detect_test_coverage
from structorium.engine.policy.zones import (
    EXCLUDED_ZONES,
    adjust_potential,
    filter_entries,
    should_skip_finding,
)
from structorium.core.file_paths import rel
...
from structorium.languages._framework.runtime import LangRuntimeContract
...
def run_structural_phase(
    ...
    *,
    ...
    if god_rules and god_extractor_fn:
        from structorium.engine.detectors.gods import detect_gods

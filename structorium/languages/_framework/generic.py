...
from structorium.core.registry import DetectorMeta, register_detector
...
from structorium.core.source_discovery import find_source_files
from structorium.languages._framework.base.types import (
    DetectorPhase,
    FixerConfig,
    LangConfig,
)
from structorium.languages._framework.generic_parts.parsers import (
    PARSERS as _PARSERS,
)
from structorium.languages._framework.generic_parts.parsers import (
    parse_cargo,
...
from structorium.languages._framework.generic_parts.tool_factories import (
    make_detect_fn,
    make_generic_fixer,
    make_tool_phase,
)
from structorium.languages._framework.generic_parts.tool_spec import (
    normalize_tool_specs,
)
from structorium.languages._framework.treesitter import (
    PARSE_INIT_ERRORS as _TS_INIT_ERRORS,
)
from structorium.scoring import DetectorScoringPolicy, register_scoring_policy
...
def generic_lang(
    ...
    *,
    ...
    """
    from structorium.languages import register_generic_lang
    ...
    if has_treesitter:
        from structorium.languages._framework.treesitter.phases import (
...
def _make_structural_phase(treesitter_spec=None) -> DetectorPhase:
    ...
    from structorium.core.output import log
    ...
    if has_class_query:
        from structorium.engine.detectors.base import GodRule
    ...
    def run(path, lang):
        from structorium.languages._framework.base.shared_phases import (

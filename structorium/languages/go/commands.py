...
from structorium.languages.go.detectors.deps import build_dep_graph
from structorium.languages.go.extractors import extract_functions, find_go_files
from structorium.languages.go.phases import GO_COMPLEXITY_SIGNALS

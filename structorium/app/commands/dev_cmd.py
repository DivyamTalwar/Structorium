...
from structorium.app.commands.dev_scaffold_templates import build_scaffold_files
...
def _wire_pyproject(lang_name: str) -> bool:
    ...
    updated = _append_toml_array_item(
        updated,
        "testpaths",
        f"structorium/languages/{lang_name}/tests",
    )
...
def _cmd_scaffold_lang(args) -> None:
    ...
    lang_dir = PROJECT_ROOT / "structorium" / "languages" / lang_name

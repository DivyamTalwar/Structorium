...
from structorium.app.commands.next_parts import output as next_output_mod
from structorium.app.commands.next_parts import render as next_render_mod
...
from structorium.engine.work_queue import (
    QueueBuildOptions,
    build_work_queue,
)
from structorium.core.output_api import colorize
from structorium.core.skill_docs import check_skill_version
from structorium.core.tooling import check_config_staleness, check_tool_staleness
from structorium.core.discovery_api import safe_write_text
from structorium.intelligence.narrative import NarrativeContext, compute_narrative
...
def _get_items(args, state: dict, config: dict) -> None:
    ...
    try:
        from structorium.scoring import merge_potentials

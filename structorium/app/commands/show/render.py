...
from structorium.app.commands.helpers.rendering import print_ranked_actions
...
from structorium.core.fallbacks import print_write_error
from structorium.core.enums import canonical_finding_status
from structorium.engine.planning import CONFIDENCE_ORDER
...
def show_agent_plan(
    ...
    if plan and (plan.get("queue_order") or plan.get("clusters")):
        from structorium.app.commands.helpers.rendering import print_agent_plan as _pap
        _pap(
            [],
            plan=plan,
    ...
    if actions:
        ...
        print(
            colorize(
                "  Agent focus: `structorium next --count 20` — "

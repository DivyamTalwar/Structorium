...
from structorium.app.commands.helpers.runtime_options import resolve_lang_runtime_options
from structorium.app.commands.helpers.score import target_strict_score_from_config
from structorium.app.commands.scan.scan_coverage import (
    coerce_int as _coerce_int,
    persist_scan_coverage as _persist_scan_coverage,
    seed_runtime_coverage_warnings as _seed_runtime_coverage_warnings,
)
from structorium.app.commands.scan.scan_helpers import (
...
from structorium.app.commands.scan.scan_wontfix import (
...
from structorium.engine import work_queue as issues_mod
from structorium.engine import planning as plan_mod
from structorium.engine.planning.scan import PlanScanOptions
from structorium.core.file_paths import rel
from structorium.core.source_discovery import (
    disable_file_cache,
    enable_file_cache,
    get_exclusions,
)
from structorium.languages._framework.base.types import DetectorCoverageRecord
from structorium.languages._framework.runtime import LangRunOverrides, make_lang_run
from structorium.core.config import save_config as _save_config
...
def _subjective_reset_dimensions(*, lang_name: str | None = None) -> tuple[str, ...]:
    ...
    from structorium.intelligence.review.dimensions.metadata import (
...
def merge_scan_results(
    ...
    try:
        from structorium.engine.plan import (
            load_plan,
        ...
        from structorium.engine._plan.auto_cluster import auto_cluster_findings

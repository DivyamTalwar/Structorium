...
from structorium.app.commands.scan.scan_helpers import format_delta
from structorium.app.commands.status_parts.strict_target import (
    format_strict_target_progress,
)
from structorium.app.commands.scan.scan_reporting_llm import _is_agent_environment
...
def show_score_delta(
    ...
    *,
    ...
    if target_strict is not None and new.strict is not None:
        from structorium.app.commands.helpers.score_update import _print_strict_target_nudge
            ...
            if streak >= 2:
                print(
                    colorize(
                        ...
                        "on `.structorium/review_packet_blind.json` and re-import before trusting subjective scores.",
                        "yellow",
                    )
                )
        elif status == "warn":

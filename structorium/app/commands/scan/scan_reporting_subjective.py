...
from structorium.app.commands.helpers.score import coerce_target_score
...
def subjective_rerun_command(
    ...
    *,
    ...
    if has_prior_review is False:
        command_parts = ["structorium", "review", "--prepare"]
        if dim_keys:
...
def show_subjective_paths(
    ...
    *,
    ...
    if parts:
        ...
        print(colorize_fn("  Run `structorium show subjective` for details.", "dim"))

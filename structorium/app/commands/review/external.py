...
from structorium.app.commands.review.runtime import setup_lang_concrete
from structorium.core._internal.coercions import coerce_positive_int
...
def _external_session_root() -> Path:
    ...
    return _runtime_project_root() / ".structorium" / "external_review_sessions"
...
def _prepare_packet_snapshot(
    ...
    *,
    ...
    next_command = "structorium review --external-submit --session-id <id> --import <file>"
    if retrospective:
        next_command += (
            " --retrospective"
...
def do_external_start(args, state, lang, *, config: dict[str, Any] | None = None) -> None:
    ...
    submit_cmd = (
        "structorium review --external-submit "

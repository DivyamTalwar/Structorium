...
def _require_batches(
    ...
    *,
    ...
    print(
        colorize_fn(
            "  Happy path: `structorium review --run-batches --runner codex --parallel --scan-after-import`.",
            "dim",
        ),
        file=sys.stderr,
    )
...
def _missing_dimensions_command(*, missing_dims: list[str], scan_path: str) -> str:
    ...
    base = "structorium review --run-batches --runner codex --parallel --scan-after-import"
...
def do_run_batches(
    ...
    *,
    ...
    suggested_prepare_cmd = f"structorium review --prepare --path {scan_path}"

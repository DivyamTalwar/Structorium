...
from structorium.core.issues_render import finding_weight
from structorium.core.output_api import colorize
from structorium.engine.work_queue import list_open_review_findings
from structorium.intelligence.narrative import NarrativeContext, compute_narrative
from structorium.state import save_state, utc_now
    ...
    write_query(
        {
            ...
            "next_command": "structorium show review --status open",
            "narrative": narrative,
        }
    )

...
from structorium import languages as lang_api
...
from structorium.languages import runtime as lang_runtime
...
def cmd_detect(args: argparse.Namespace) -> None:
    ...
    if not getattr(args, "json", False):
        ...
        print(
            colorize(f"\n  Next command: `structorium scan --path {scan_path}`", "dim"),
            file=sys.stderr,
        )

...
from structorium.engine.plan import load_plan, save_plan


def _cmd_plan_generate(args: argparse.Namespace) -> None:
    """Generate the prioritized markdown plan (existing behavior)."""
    from structorium.app.commands.plan_cmd import cmd_plan_output
...
def _cmd_plan_reset(args: argparse.Namespace) -> None:
    ...
    from structorium.engine.plan import reset_plan
...
def cmd_plan(args: argparse.Namespace) -> None:
    ...
    if plan_action == "queue":
        from structorium.app.commands.plan.queue_render import cmd_plan_queue
    ...
    if plan_action == "move":
        from structorium.app.commands.plan.move_handlers import cmd_plan_move
    ...
    if plan_action in (
        ...
        from structorium.app.commands.plan.override_handlers import (
            cmd_plan_describe,
            cmd_plan_done,
            cmd_plan_focus,
            cmd_plan_note,
    ...
    if plan_action == "cluster":
        from structorium.app.commands.plan.cluster_handlers import cmd_cluster_dispatch

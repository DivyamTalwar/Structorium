...
from structorium.app.commands.plan._resolve import resolve_ids_from_patterns
...
def cmd_plan_describe(args: argparse.Namespace) -> None:
    ...
    from structorium.engine.plan import describe_finding
...
def cmd_plan_note(args: argparse.Namespace) -> None:
    ...
    from structorium.engine.plan import annotate_finding
...
def cmd_plan_skip(args: argparse.Namespace) -> None:
    ...
    from structorium.app.commands.resolve.selection import (
...
def cmd_plan_done(args: argparse.Namespace) -> None:
    ...
    from structorium.app.commands.resolve.cmd import cmd_resolve

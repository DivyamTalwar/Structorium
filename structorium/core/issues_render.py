...
def _append_footer(
    ...
    *,
    ...
    if has_investigation:
        ...
        lines.append("```bash")
        lines.append(f'structorium plan done "{finding_id}"')
        lines.append("```\n")
        return
    ...
    lines.append("```bash")
    lines.append(
        f'structorium plan done "{finding_id}" --note "description of fix"'
    )
    lines.append("```\n")
    lines.append("Or save detailed analysis first:\n")
    lines.append("```bash")
    lines.append(
        f'structorium show "{finding_id}" --notes analysis.md'
    )
    lines.append("```\n")

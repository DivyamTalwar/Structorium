...
from structorium.core._internal import text_utils as _text_utils
...
_SRC_PATH_SENTINEL = PROJECT_ROOT / os.environ.get("STRUCTORIUM_SRC", "src")
...
def get_src_path() -> Path:
    ...
    return get_project_root() / os.environ.get("STRUCTORIUM_SRC", "src")

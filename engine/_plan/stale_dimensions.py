...
from engine._plan.schema import PlanModel, ensure_plan_defaults
from engine._state.schema import StateModel
...
def _current_stale_ids(state: StateModel) -> set[str]:
    ...
    from engine._work_queue.helpers import slugify

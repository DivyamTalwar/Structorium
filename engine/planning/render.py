...
from engine.planning.common import TIER_LABELS
from engine.planning.types import PlanState
from engine.work_queue import QueueBuildOptions, build_work_queue
from scoring import DIMENSIONS, DISPLAY_NAMES
from state import get_objective_score, get_overall_score, get_strict_score
from core.output_api import LOC_COMPACT_THRESHOLD
...
def _plan_dimension_table(state: PlanState) -> list[str]:
    ...
    from engine.planning.dimension_rows import scorecard_dimension_rows

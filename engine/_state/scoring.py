...
from engine._scoring.policy.core import matches_target_score
from engine._state.filtering import path_scoped_findings
from engine._state.schema import StateModel, ensure_state_defaults
from languages._framework.base.types import ScanCoverageRecord
...
def _update_objective_health(
    ...
    *,
    ...
    # Deferred import to avoid circular dependency with scoring
    ...
    if lang_name:
        try:
            from intelligence.review.dimensions.data import (

...
from languages.csharp.detectors.deps import cmd_cycles as cmd_cycles_deps
from languages.csharp.detectors.deps import cmd_deps as cmd_deps_direct
from languages.csharp.extractors import (
    extract_csharp_functions,
    find_csharp_files,
)
from languages.csharp.phases import CSHARP_COMPLEXITY_SIGNALS

...
- What each file in `languages/csharp/` is responsible for
...
- `languages/csharp/commands.py`
- `languages/csharp/extractors.py`
- `languages/csharp/phases.py`
- `languages/csharp/detectors/deps.py`
- `languages/csharp/detectors/security.py`
- `languages/csharp/detectors/__init__.py`
- `languages/csharp/fixers/__init__.py`
...
Main config class: `languages/csharp/__init__.py`.
...
`languages/_framework/base/` (notably `types.py` and `shared_phases.py`):
...
- `tests/lang/csharp/test_csharp_init.py`
- `tests/lang/csharp/test_csharp_commands.py`
- `tests/lang/csharp/test_csharp_extractors.py`
- `tests/lang/csharp/test_csharp_deps.py`
- `tests/lang/csharp/test_csharp_scan.py`
- `tests/lang/csharp/test_test_coverage_csharp.py`
...
When adding behavior, always add tests in `tests/lang/csharp/test_csharp_*.py` and, if needed, a focused fixture under `tests/fixtures/csharp/`.

...
from engine.detectors import dupes as dupes_detector_mod
...
from core.discovery_api import find_py_files, rel
...
from languages.python.detectors import smells as smells_detector_mod
from languages.python.detectors import unused as unused_detector_mod
from languages.python.extractors import (
    detect_passthrough_functions,
    extract_py_functions,
)
from languages.python.extractors_classes import extract_py_classes
from core.output_api import colorize, display_entries, print_table

if TYPE_CHECKING:
    import argparse

from languages._framework.commands_base import (
    make_cmd_complexity,
    make_cmd_facade,
    make_cmd_large,
    make_cmd_naming,

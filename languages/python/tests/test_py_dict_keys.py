"""Tests for languages.python.detectors.dict_keys — dict key flow analysis."""

import textwrap
from pathlib import Path

from languages.python.detectors import dict_keys as dict_keys_mod
from languages.python.detectors.dict_keys import (

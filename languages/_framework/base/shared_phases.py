...
from core._internal.coercions import coerce_confidence
from core._internal.text_utils import get_project_root
from engine.detectors.base import ComplexitySignal
from engine.detectors.complexity import detect_complexity
from engine.detectors.dupes import detect_duplicates
from engine.detectors.flat_dirs import (
    detect_flat_dirs,
    format_flat_dir_summary,
)
from engine.detectors.graph import detect_cycles
from engine.detectors.jscpd_adapter import detect_with_jscpd
from engine.detectors.large import detect_large_files
from engine.detectors.orphaned import (
    OrphanedDetectionOptions,
    detect_orphaned_files,
)
from engine.detectors.review_coverage import (
    detect_holistic_review_staleness,
    detect_review_coverage,
)
from engine.detectors.security.detector import detect_security_issues
from engine.detectors.single_use import detect_single_use_abstractions
from engine.detectors.test_coverage.detector import detect_test_coverage
from engine.policy.zones import (
    EXCLUDED_ZONES,
    adjust_potential,
    filter_entries,
    should_skip_finding,
...
from languages._framework.runtime import LangRuntimeContract
...
def run_structural_phase(
    ...
    *,
    ...
    if god_rules and god_extractor_fn:
        from engine.detectors.gods import detect_gods

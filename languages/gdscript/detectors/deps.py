...
from engine.detectors.graph import finalize_graph
from core.discovery_api import resolve_path
from languages.gdscript.extractors import find_gdscript_files
from languages.gdscript.patterns import EXTENDS_RE, LOAD_PATH_RE

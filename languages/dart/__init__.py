...
from languages.dart import test_coverage as dart_test_coverage_hooks
from languages.dart.commands import get_detect_commands
from languages.dart.detectors.deps import (
    build_dep_graph as build_dart_dep_graph,
)
from languages.dart.extractors import (
    DART_FILE_EXCLUSIONS,
    extract_functions,
    find_dart_files,
)
from languages.dart.phases import _phase_coupling, _phase_structural
from languages.dart.review import (

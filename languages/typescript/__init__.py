...
from core.source_discovery import find_ts_files
...
from languages._framework.treesitter.phases import make_cohesion_phase
from languages.typescript import commands as ts_commands_mod
from languages.typescript import fixers as ts_fixers_mod
from languages.typescript import test_coverage as ts_test_coverage_hooks
...
from languages.typescript.detectors.security import detect_ts_security
from languages.typescript.extractors import extract_ts_functions
from languages.typescript.phases import (
    TS_COMPLEXITY_SIGNALS as TS_COMPLEXITY_SIGNALS,
)
from languages.typescript.phases import TS_GOD_RULES as TS_GOD_RULES
from languages.typescript.phases import TS_SKIP_DIRS as TS_SKIP_DIRS
from languages.typescript.phases import TS_SKIP_NAMES as TS_SKIP_NAMES
from languages.typescript.phases import (
    phase_coupling,
    phase_deprecated,
    phase_exports,
...
from languages.typescript.review import (
...
from languages.typescript.review import REVIEW_GUIDANCE as TS_REVIEW_GUIDANCE
from languages.typescript.review import api_surface as ts_review_api_surface
from languages.typescript.review import (
...
def _ts_treesitter_phases() -> list[DetectorPhase]:
    ...
    """
    from languages._framework.treesitter import get_spec, is_available

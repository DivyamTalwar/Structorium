...
from languages.typescript.detectors._smell_helpers import scan_code
from languages.typescript.fixers.fixer_io import apply_fixer
from languages.typescript.fixers.syntax_scan import collapse_blank_lines

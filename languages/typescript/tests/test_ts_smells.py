"""Tests for languages.typescript.detectors.smells — TS/React code smell detection."""

from pathlib import Path

import pytest

import languages.typescript.detectors.smells as smells_detector_mod
from languages.typescript.detectors.smells import detect_smells

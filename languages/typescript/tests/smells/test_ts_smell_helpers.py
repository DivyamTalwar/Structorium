"""Tests for languages.typescript.detectors._smell_helpers — string processing helpers."""

from languages.typescript.detectors._smell_detectors import (
...
from languages.typescript.detectors._smell_helpers import (
...
from languages.typescript.detectors.smells import TS_SMELL_CHECKS

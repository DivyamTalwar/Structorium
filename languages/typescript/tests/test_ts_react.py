"""Tests for languages.typescript.detectors.react — React anti-pattern detection."""

from pathlib import Path

import pytest

import languages.typescript.detectors.react as react_detector_mod
from languages.typescript.detectors.react import (

...
from core.file_paths import rel, resolve_path
from core.grep import grep_files
from core.output import colorize, print_table
...
from languages.typescript.detectors.deps_runtime import (

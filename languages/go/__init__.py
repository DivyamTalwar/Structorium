...
from languages._framework.generic import make_tool_phase
from languages._framework.treesitter.phases import all_treesitter_phases
from languages.go import test_coverage as go_test_coverage_hooks
from languages.go.commands import get_detect_commands
from languages.go.detectors.deps import build_dep_graph as build_go_dep_graph
from languages.go.extractors import (
    GO_FILE_EXCLUSIONS,
    extract_functions,
    find_go_files,
)
from languages.go.phases import _phase_structural
from languages.go.review import (

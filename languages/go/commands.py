...
from languages.go.detectors.deps import build_dep_graph
from languages.go.extractors import extract_functions, find_go_files
from languages.go.phases import GO_COMPLEXITY_SIGNALS

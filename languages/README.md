...
from languages._framework.treesitter._specs import MY_SPEC  # if available
...
pytest -q tests/lang/common/ languages/*/tests/

# Run one language's tests
pytest -q languages/go/tests/

# Validate plugin contracts
pytest -q tests/lang/common/test_lang_standardization.py
```

...
from intelligence.narrative._constants import STRUCTURAL_MERGE
from intelligence.narrative.action_engine import compute_actions
from intelligence.narrative.action_models import (
    ActionContext,
)
from intelligence.narrative.action_tools import compute_tools
from intelligence.narrative.dimensions import (
    _analyze_debt,
    _analyze_dimensions,
)
...
from intelligence.narrative.strategy_engine import compute_strategy
from intelligence.narrative.types import (
    BadgeStatus,
    NarrativeResult,
    PrimaryAction,
    RiskFlag,

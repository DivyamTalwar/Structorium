...
from app.output.scorecard_parts.dimensions import (
...
from app.output.scorecard_parts.theme import (
    ACCENT,
    BG,
    BG_ROW_ALT,
    BG_SCORE,
...
def generate_scorecard(state: dict, output_path: str | Path) -> Path:
    ...
    scorecard_draw_mod = importlib.import_module("app.output.scorecard_parts.draw")  # deferred: depends on PIL

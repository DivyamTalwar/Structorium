...
from app.output.tree_text import render_tree_lines
from core.file_paths import resolve_scan_file
...
from core.discovery_api import rel, safe_write_text
...
def _resolve_visualization_lang(path: Path, lang):
    ...
    if lang:
        return lang
    from languages import auto_detect_lang, get_lang
...
def _fallback_source_files(path: Path) -> list[str]:
    ...
    from core.discovery_api import find_source_files

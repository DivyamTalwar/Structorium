...
from app.commands.helpers.rendering import print_agent_plan, print_ranked_actions
from app.commands.helpers.subjective import print_subjective_followup
from app.commands.scan import (
    scan_reporting_dimensions as reporting_dimensions_mod,
)
from app.commands.scan.scan_reporting_presentation import dimension_bar
from app.commands.status_parts.summary import (
...
from core.registry import dimension_action_type
from scoring import (
    DIMENSIONS,
...
from core.output_api import colorize, print_table

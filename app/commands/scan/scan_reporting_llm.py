...
from app.commands.scan.scan_reporting_text import build_workflow_guide
from engine.planning import scorecard_projection as scorecard_projection_mod
from core import registry as registry_mod
from core._internal.text_utils import PROJECT_ROOT
from core import skill_docs as skill_docs_mod
from engine.work_queue import ATTEST_EXAMPLE
...
def _try_auto_update_skill() -> None:
    ...
    try:
        from app.commands.update_skill import (
            resolve_interface,
...
def _print_llm_summary(
    ...
    try:
        from engine.plan import load_plan
        _plan = load_plan()
        _has_plan = bool(

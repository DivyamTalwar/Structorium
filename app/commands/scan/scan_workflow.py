...
from app.commands.scan.scan_wontfix import (
    augment_with_stale_wontfix_findings as _augment_stale_wontfix_impl,
)
from core._internal.text_utils import PROJECT_ROOT
from engine import work_queue as issues_mod
from engine import planning as plan_mod
from engine.planning.scan import PlanScanOptions
...
from languages._framework.base.types import DetectorCoverageRecord
from languages._framework.runtime import LangRunOverrides, make_lang_run
...
def _subjective_reset_dimensions(*, lang_name: str | None = None) -> tuple[str, ...]:
    ...
    from intelligence.review.dimensions.metadata import (
...
def merge_scan_results(
    ...
    try:
        ...
        from engine._plan.auto_cluster import auto_cluster_findings

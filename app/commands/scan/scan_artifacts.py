...
def _load_scorecard_helpers():
    ...
    """
    try:
        scorecard_module = importlib.import_module("app.output.scorecard")
    except ImportError:
        return None, None

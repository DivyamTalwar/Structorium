...
def _cmd_plan_reset(args: argparse.Namespace) -> None:
    ...
    from engine.plan import reset_plan
...
def cmd_plan(args: argparse.Namespace) -> None:
    ...
    if plan_action == "queue":
        from app.commands.plan.queue_render import cmd_plan_queue
    ...
    if plan_action == "move":
        from app.commands.plan.move_handlers import cmd_plan_move
    ...
    if plan_action in (
        ...
        from app.commands.plan.override_handlers import (
            cmd_plan_describe,
            cmd_plan_done,
            cmd_plan_focus,
            cmd_plan_note,
    ...
    if plan_action == "cluster":
        from app.commands.plan.cluster_handlers import cmd_cluster_dispatch

...
from app.commands.next_parts import output as next_output_mod
from app.commands.next_parts import render as next_render_mod
...
from engine.work_queue import (
    QueueBuildOptions,
    build_work_queue,
)
from core.output_api import colorize
from core.skill_docs import check_skill_version
from core.tooling import check_config_staleness, check_tool_staleness
from core.discovery_api import safe_write_text
from intelligence.narrative import NarrativeContext, compute_narrative
...
def _get_items(args, state: dict, config: dict) -> None:
    ...
    try:
        from scoring import merge_potentials

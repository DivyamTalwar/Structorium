...
from app.commands.helpers.rendering import print_ranked_actions
...
from core.fallbacks import print_write_error
from core.enums import canonical_finding_status
from engine.planning import CONFIDENCE_ORDER
...
def show_agent_plan(
    ...
    if plan and (plan.get("queue_order") or plan.get("clusters")):
        from app.commands.helpers.rendering import print_agent_plan as _pap
        _pap(
            [],
            plan=plan,

...
from app.commands.scan.scan_reporting_subjective import (
    build_subjective_followup,
)
from engine.planning.scorecard_projection import (
    scorecard_subjective_entries,
)
from engine.work_queue import ATTEST_EXAMPLE, group_queue_items
from intelligence.integrity import (
...
from core.paths_api import read_code_snippet
...
def _render_item(
    ...
    if potentials and detector and dim_scores:
        try:
            from scoring import compute_score_impact

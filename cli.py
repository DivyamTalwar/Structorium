...
from app.cli_support.parser import create_parser as _create_parser
from app.commands.helpers.lang import LangResolutionError, resolve_lang
...
from core.discovery_api import set_exclusions
from core.output_api import colorize
from core.paths_api import get_default_path
from core.runtime_state import runtime_scope
...
def _get_detector_names() -> list[str]:
    ...
    if _DETECTOR_NAMES is None:
        from core.registry import detector_names
